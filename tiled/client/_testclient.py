"""
Vendored from starlette.testclient and starlette._utils
commit 3ac06f04c1096052d7492401b33286f6c71fb7ad
because TestClient was recently rewritten to use httpx instead of requests
and that rewrite has not yet been released.
"""
import asyncio
import contextlib
import functools

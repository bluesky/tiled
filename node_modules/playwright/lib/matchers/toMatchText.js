...
async function toMatchText(matcherName, receiver, receiverType, query, expected, options = {}) {
  ...
  const messagePrefix = (0, import_matcherHint.matcherHint)(this, receiver, matcherName, options.receiverLabel ?? "locator", void 0, matcherOptions, timedOut ? timeout : void 0);
